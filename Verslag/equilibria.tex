...
Then we have $ab\sigma = det(A_0) = \lambda_1\lambda_2\lambda_3 > 0$.
If without generality we assume that $\lambda_1 \leq \lambda_2 \leq
\lambda_3$, we can again distinguish two cases.  If $\lambda_1 < 0$,
we must have $\lambda_2 < 0$ and $\lambda_3 > 0$.  This corresponds to
a saddle with a stable plane, spanned by the (generalized) eigenvectors
